...
func TestScanResults(t *testing.T) {
	...
	g.Describe("Untranslated Scan Results", func() {
		g.It("should parse untranslated scan results", func() {
			...
			Expect(untranslatedRiskResult.Risk.Risk.Scores.Value).To(Equal(28.564960310922192))
	...
	g.Describe("Translated Scan Results", func() {
		...
		g.It("should unmarshal a scan results with risk data", func() {
			...
			Expect(ok).To(Equal(true))
			Expect(e.Risk.ID).To(Equal("pkg:github/lodash/lodash"))
		})
		...
		g.It("should marshal a scan result with risk data", func() {
			...
			b, err := json.Marshal(r)
			Expect(err).To(BeNil())
			Expect(string(b)).To(Equal("{\"type\":\"risk\",\"data\":{\"id\":\"\",\"name\":\"\",\"org\":\"\",\"version\":\"\",\"sources\":null,\"score\":{\"name\":\"Software\",\"value\":0,\"scopes\":null},\"summary\":\"\",\"risk_tags\":null}}"))
		})
...
const (
	...
	SampleValidScanResultsRisk          = `{"type":"risk","data":{"id":"pkg:github/lodash/lodash","name":"lodash","org":"lodash","version":"","sources":[{"type":"repo","source":["github"],"id":"pkg:github/lodash/lodash"}],"score":{"name":"pkg:github/lodash/lodash","value":28.564960310922192,"scopes":[{"name":"ecosystem","value":76.36665881302588},{"name":"technology","value":62.598764089169386},{"name":"supply_chain","value":17.541160386140582}]},"summary":"Metrics indicate that this component sample one point explanation, and sample one point explanation. Therefore, this component may have an associated integration risk.","risk_tags":[{"name":"integration","description":"this is a description of integration risk","severity":"yellow"},{"name":"bus factor","description":"this is a description of bus factor risk","severity":"yellow"}]}}`
	...
	SampleValidUntranslatedScanResultsRisk          = `{"risk": {"id":"pkg:github/lodash/lodash","name":"lodash","org":"lodash","version":"","sources":[{"type":"repo","source":["github"],"id":"pkg:github/lodash/lodash"}],"score":{"name":"pkg:github/lodash/lodash","value":28.564960310922192,"scopes":[{"name":"ecosystem","value":76.36665881302588},{"name":"technology","value":62.598764089169386},{"name":"supply_chain","value":17.541160386140582}]},"summary":"Metrics indicate that this component sample one point explanation, and sample one point explanation. Therefore, this component may have an associated integration risk.","risk_tags":[{"name":"integration","description":"this is a description of integration risk","severity":"yellow"},{"name":"bus factor","description":"this is a description of bus factor risk","severity":"yellow"}]}}`
